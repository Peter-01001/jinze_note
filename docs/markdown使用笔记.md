...
**标题**，**段落**，**区块引用**，**代码区块**，**强调**，**列表**，**分割线**，**链接**，**图片**，**反斜杠 [\](file://d:\note\BT\Big%20talk%20data%20structure.md)**，**符号'`'**。
...
有序列表的标记方式是将上述的符号换成数字,并辅以[.](file://d:\note\BT\Big%20talk%20data%20structure.md)，如：
> 1 . 第一项
> 2 . 第二项
> 3 . 第三项
...
#### 4.10 反斜杠[\](file://d:\note\BT\Big%20talk%20data%20structure.md)
